...
* [x] Using ajax when adding items to, removing items from cart and applying coupon code.
...
![Video Walkthrough](https://github.com/reddevilcf17/devilrestaurant/raw/master/app/assets/images/walkthrough.gif)
